...
import { TENDING_APK_URL } from '@/constants/profile';
...
export default function HouseholdCreatedScreen() {
  ...
  async function shareCode() {
    ...
    await Share.share({
      message: householdShareMessage(params.joinCode, TENDING_APK_URL),
    });
  }
  ...
  return (
    <SovereignScreen style={styles.container}>
      ...
      <Text style={[styles.waiting, { color: colors.textMuted }]}>
        {partnerJoined ? 'Holli has joined.' : 'Waiting for Holli to join...'}
      </Text>
